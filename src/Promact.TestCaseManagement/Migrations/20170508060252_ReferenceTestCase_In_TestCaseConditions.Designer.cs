...
namespace Promact.TestCaseManagement.Web.Migrations
{
    ...
    partial class ReferenceTestCase_In_TestCaseConditions
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Promact.TestCaseManagement.DomainModel.Models.TestCaseConditions", b =>
                {
                    ...
                    b.Property<int?>("ReferenceTestCaseId");

                    b.Property<int>("TestCaseId");

                    b.HasKey("Id");

                    b.HasIndex("ReferenceTestCaseId");
            ...
            modelBuilder.Entity("Promact.TestCaseManagement.DomainModel.Models.TestCaseStepsResultHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("TestCaseStepsResultHistory");
                });
            ...
            modelBuilder.Entity("Promact.TestCaseManagement.DomainModel.Models.TestCaseConditions", b =>
                {
                    b.HasOne("Promact.TestCaseManagement.DomainModel.Models.TestCase", "ReferenceTestCase")
                        .WithMany()
                        .HasForeignKey("ReferenceTestCaseId");
            ...
            modelBuilder.Entity("Promact.TestCaseManagement.DomainModel.Models.TestCaseStepsResultHistory", b =>
                {
                    ...
                    b.HasOne("Promact.TestCaseManagement.DomainModel.Models.TestCaseSteps", "TestCaseSteps")
                        .WithMany("TestCaseStepsResultHistory")
                        .HasForeignKey("TestCaseStepsId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
